...
INSERT INTO `items` (`name`, `label`, `limit`) VALUES
  ('alive_chicken', 'Poulet vivant', 25),
  ('slaughtered_chicken', 'Poulet abattu', 25),
  ('packaged_chicken', 'Poulet en barquette', 50),
  ('fish', 'Poisson', 50),
  ('stone', 'Pierre', 10),
  ('washed_stone', 'Pierre Lavée', 10),
  ('copper', 'Cuivre', 50),
  ('iron', 'Fer', 40),
  ('gold', 'Or', 20),
  ('diamond', 'Diamant', 1),
  ('wood', 'Bois', 25),
  ('cutted_wood', 'Bois coupé', 25),
  ('packaged_plank', 'Paquet de planches', 50),
  ('petrol', 'Pétrole', 25),
  ('petrol_raffin', 'Pétrole Raffiné', 25),
  ('essence', 'Essence', 50),
  ('wool', 'Laine', 25),
  ('fabric', 'Tissu', 25),
  ('clothe', 'Vêtement', 50)
