...
if Config.MaxInService ~= -1 then
  TriggerEvent('esx_service:activateService', 'Dolce', Config.MaxInService)
end

TriggerEvent('esx_phone:registerNumber', 'Dolce', _U('Dolce_customer'), true, true)
TriggerEvent('esx_society:registerSociety', 'Dolce', 'Dolce', 'society_Dolce', 'society_Dolce', 'society_Dolce', {type = 'private'})



RegisterServerEvent('esx_Dolce:getStockItem')
AddEventHandler('esx_Dolce:getStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_Dolce', function(inventory)
...
ESX.RegisterServerCallback('esx_Dolce:getStockItems', function(source, cb)
...
RegisterServerEvent('esx_Dolce:putStockItems')
AddEventHandler('esx_Dolce:putStockItems', function(itemName, count)
...
RegisterServerEvent('esx_Dolce:getFridgeStockItem')
AddEventHandler('esx_Dolce:getFridgeStockItem', function(itemName, count)

  local xPlayer = ESX.GetPlayerFromId(source)

  TriggerEvent('esx_addoninventory:getSharedInventory', 'society_Dolce_fridge', function(inventory)
...
ESX.RegisterServerCallback('esx_Dolce:getFridgeStockItems', function(source, cb)
...
RegisterServerEvent('esx_Dolce:putFridgeStockItems')
AddEventHandler('esx_Dolce:putFridgeStockItems', function(itemName, count)
...
RegisterServerEvent('esx_Dolce:buyItem')
AddEventHandler('esx_Dolce:buyItem', function(itemName, price, itemLabel)
    ...
    TriggerEvent('esx_addonaccount:getSharedAccount', 'society_Dolce', function(account)
...
RegisterServerEvent('esx_Dolce:craftingCoktails')
AddEventHandler('esx_Dolce:craftingCoktails', function(itemValue)
...
ESX.RegisterServerCallback('esx_Dolce:getVaultWeapons', function(source, cb)

  TriggerEvent('esx_datastore:getSharedDataStore', 'society_Dolce', function(store)
...
ESX.RegisterServerCallback('esx_Dolce:addVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_Dolce:removeVaultWeapon', function(source, cb, weaponName)
...
ESX.RegisterServerCallback('esx_Dolce:getPlayerInventory', function(source, cb)
